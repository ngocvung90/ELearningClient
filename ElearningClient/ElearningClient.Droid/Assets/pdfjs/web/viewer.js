...
function goNext()
{
    if (PDFViewerApplication.page >= PDFViewerApplication.pageCount) return;
    PDFViewerApplication.page++;
}
...
function goToPage(numbPage)
{
    if (numbPage < 1) PDFViewerApplication.page = 1;
    else if (numbPage > PDFViewerApplication.pagesCount) PDFViewerApplication.page = PDFViewerApplication.pagesCount;
    else PDFViewerApplication.page = numbPage;
}
...
function renderPage(num) {
    ...
    pdPDFViewerApplication.pdfDocumentfDoc.getPage(num).then(function (page) {
